...
~~~
python extractor_new.py --infile=$outFile1 --appversion=$DUNE_VERSION --appname=${APP_TAG}  --appfamily=larsoft --no_crc --inputDidsFile=justin-input-dids.txt  --data_tier='full-reconstructed' --file_format='artroot' --fcl_file=${FCL_FILE_NAME} --namespace=${NAMESPACE} #> $outFile1.json
~~~
{: ..language-bash}
...
~~~
python ~/extractor_new.py --infile=/pnfs/dune/persistent/staging/fardet-hd/29/a0/atmnu_max_weighted_randompolicy_dune10kt_1x2x6_50542214_117_20231201T220548Z_gen_g4_detsim_hitreco_20260626T114201Z_reco2.root --namespace=schellma --appname=reco2 --inputDidsFile=parent_dids.txt
~~~
{: ..language-bash}
